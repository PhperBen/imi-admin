 ...
 * @Table(name=@ConfigValue(name="@app.models.ImiApp\ApiServer\Backend\Model\User.name", default="user"), id={"id"}, dbPoolName=@ConfigValue(name="@app.models.ImiApp\ApiServer\Backend\Model\User.poolName"))
